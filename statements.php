    ...
    <div class="page-wrapper">
        ...
        <div class="content-wrapper">
            <div class="page-heading">
                <h1 class="page-title my-0">Statements</h1>
            </div>
            <!-- START PAGE CONTENT-->
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="align-middle text-end">
                                        &#8377; 55,000
                                        <i class="fas fa-long-arrow-up text-success"></i>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td class="align-middle text-end">
                                        &#8377; 25,000
                                        <i class="fas fa-long-arrow-down text-danger"></i>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <div class="col">
                                <label><i class="fas fa-hand-holding-usd"></i> Cash Book</label>
                        ...
                        <div class="form-group">
                            <div class="col">
                                <label><i class="fas fa-hand-holding-usd"></i> Source</label>
                                <select class="form-control" id="source" name="source" required>
                        ...
                        <div class="form-group">
                            <div class="col">
                                <label><i class="fas fa-border-all"></i> Category</label>
